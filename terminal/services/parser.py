...
class Parser:
    ...
    def parse_before_after_response(self, ai_response: str) -> str:
        try:      
        ...
        try:
            ...
            if not absolute_file_path.exists():
                ...
                if parent_dir and not parent_dir.exists():
                    # Parent directory doesn't exist, but that's okay
                    # We'll create it during apply_pending_changes
                    pass
